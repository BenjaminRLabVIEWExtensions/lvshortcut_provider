...
|SupportedType|Specifies a GUID that represents the type of project item. Must be formatted as following: {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}|
|Alias|Is a unique string that like the GUID, is used to identify the type of a project item (applies to Primary providers only). The SupportedType token in a secondary provider can point to the Alias of the item type it wants to attach to instead of the GUID.|
|IsPrimary|1 – Primary provider (defines a new item type in the project). 0 – Secondary provider (adds functionality to existing item(s) in
the project).|
...
|Signature|Digital signature – generated by NI.|
...
[Provider]=
SupportedType={GUID}
GlobalItemInterfaceVI=..\<Project Provider Name>\<Project Provider Name>_Global_Interface.vi
ItemInterfaceVI=..\<Project Provider Name>\<Project Provider Name>_Item_Interface.vi
ProviderInterfaceVI=..\<Project Provider Name>\<Project Provider Name>_Provider_Interface.vi
IsPrimary=0
LicenseName=None
InterfaceVersion=1.0
Signature=W25LJX7JW5RTK2LL5JJT9WN7C7X7BLT5
